...
- **Signal History Storage**: Automatically saves generated signals to a JSON file, maintaining a rolling window of the last 1000 signals for backtesting and performance analysis.
...
- **Lifecycle Management**: Modern `lifespan` context manager for startup/shutdown events.
