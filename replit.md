...
- **Signal Engine**: An 8-factor weighted scoring system (0-100) generates signals based on Liquidations, Funding Rate, Price Momentum, Long/Short Ratio, Smart Money, OI Trend, Social Sentiment, and Fear & Greed.
